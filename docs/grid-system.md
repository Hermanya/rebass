...
Rebass includes the incredibly flexible, responsive flexbox grid system [Grid Styled][native-grid-styled].
...
See the [Grid Styled documentation][native-grid-styled] for more.
