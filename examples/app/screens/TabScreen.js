...
export class TabScreen extends React.Component {
  ...
  Hello
        ...
        <RebassNative.Code bg="black" color="lime" p={4}>{`<Tab borderColor='blue'>
  Hello
</Tab>
`}</RebassNative.Code>
    ...
    this.props.navigation.navigate('TabHelperScreen')
  }}>TabHelper</RebassNative.ButtonOutline></RebassNative.Flex>
