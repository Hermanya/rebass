...
export class ButtonCircleScreen extends React.Component {
...
/>
        ...
        <RebassNative.Code bg="black" color="lime" p={4}>{`<ButtonCircle
  children='Hello'
/>
`}</RebassNative.Code>
  ...
  }}>Button</RebassNative.ButtonOutline><RebassNative.Text> → </RebassNative.Text><RebassNative.ButtonOutline onPress={() => {
...
<RebassNative.Column flexGrow={1} width={1/3}>9999</RebassNative.Column>
