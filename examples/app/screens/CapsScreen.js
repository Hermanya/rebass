...
export class CapsScreen extends React.Component {
  ...
  render () {
    return (
      <ScrollView>
        ...
        <RebassNative.Code bg="black" color="lime" p={4}>{`<Caps children="Example"/>`}</RebassNative.Code>
...
<RebassNative.Column flexGrow={1} width={1/3}>fontSizes</RebassNative.Column>
    ...
    <RebassNative.Column flexGrow={1} width={1/3}>letterSpacing</RebassNative.Column>
<RebassNative.Column flexGrow={1} width={1/3}>4</RebassNative.Column>
<RebassNative.Column flexGrow={1} width={1/3}>letterSpacings</RebassNative.Column>
