...
export class ContainerScreen extends React.Component {
  ...
  Hello
        ...
        <RebassNative.Code bg="black" color="lime" p={4}>{`<Container>
  Hello
</Container>
`}</RebassNative.Code>
...
<RebassNative.Column flexGrow={1} width={1/3}>auto</RebassNative.Column>
<RebassNative.Column flexGrow={1} width={1/3}>space</RebassNative.Column>
...
<RebassNative.Column flexGrow={1} width={1/3}>1024</RebassNative.Column>
